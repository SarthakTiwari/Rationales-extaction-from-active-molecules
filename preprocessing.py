    ...
    results = one_of_k_encoding_unk(
      ...
      [
        ...
        'Unknown'
              ...
              ]) + [atom.GetIsAromatic()] + [atom.GetMass() * 0.01]######
...
def smile_to_graph(smile):
    ...
    for bond in molecule.GetBonds():
        ...
        edge_features[i, j,4:] = one_of_k_encoding_unk(int(bond.GetStereo()), list(range(6)))#####
        edge_features[j, i, bond_type] = 1
        edge_features[j, i,4:] = one_of_k_encoding_unk(int(bond.GetStereo()), list(range(6)))#####
